...
For _"Plug and play"_ version `.ex5` (`mt5R v0_1_1.ex5`)

1. [Download `mt5R v0_1_1.ex5`](https://github.com/Kinzel/mt5R/raw/main/MT5%20files/mt5R%20v0_1_1.ex5).
2. Move `mt5R v0_1_1.ex5` to `...\MQL5\experts\` folder. To check where MT5's folders, open MT5 and `Tools > Options > Storage`.
...
* For non compiled version `.mq5` (`mt5R v0_1_1.mq5`) - The most suitable for developers.
  ...
  + [Download `mt5R v0_1_1.mq5`](https://github.com/Kinzel/mt5R/raw/main/MT5%20files/mt5R%20v0_1_1.mq5).
  + Move `mt5R v0_1_1.mq5` code to `...\MQL5\experts\` folder.
  + Open MetaEditor (F4).
  + Compile `mt5R v0_1_1.mq5`.
  + If everything run smooth an executable program file `mt5R v0_1_1.ex5` (or the name you chose) will be generated.
