...
mt5R is a [R](https://www.r-project.org) package that provides a framework for MT5 users that want to achieve Machine Learning analysis and trading. It provides easy integration with socket connection to reach maximum performance.
...
```{r plot, out.height = "20%" , fig.align= "center"}
#library(quantmod)
...
2. Move `mt5R v0_1_0.ex5` to `...\MQL5\experts\` folder. To check where MT5 is installed: Open MT5 > Tools > Options > Storage.
